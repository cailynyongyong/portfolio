      ...
      <main className="mx-auto max-w-2xl px-6 py-16 sm:px-8 sm:py-20">
        ...
        <section className="mb-12 space-y-4 text-black leading-relaxed text-sm">
          <p>
            ...
            <LinkPreview
              href="https://www.usemomo.com"
              className="underline"
              preview={{
                title: "Momo - Unified Inbox",
                description:
                  "An unified inbox with context awareness that never misses high-value deals",
                image: "/momo-website.png",
              }}
            >
              Momo
            </LinkPreview>
            ...
            <LinkPreview
              href="https://www.youtube.com/@10xaiclub"
              className="underline"
              preview={{
                title: "10X AI Club",
                description:
                  "AI community for non-devs to learn how to build their own AI agents. 33K subscribers.",
                image: "/10xaiclub.png",
              }}
            >
            ...
            <LinkPreview
              href="https://product.kyobobook.co.kr/detail/S000213495686"
              className="underline"
              preview={{
                title: "AI Agents Book",
                description: "Best-selling book on building AI agents",
                image: "/book.png",
              }}
            >
              best-selling book
          ...
          <p>
            ...
            <LinkPreview
              ...
              preview={{
                ...
                description:
                  "Automate smart contract auditing for Solidity developers",
                image: "/solidity.png",
              }}
            >
              Solidity Copliot,
          ...
          <p>
            ...
            <LinkPreview
              ...
              className="underline"
              preview={{
                title: "My YC intro video",
                description: "have fun watching",
                video: "/momo-founder-intro.mov",
              }}
            >
              Ironman fan
            </LinkPreview>{" "}
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>
                ...
                <LinkPreview
                  ...
                  className="underline"
                  preview={{
                    title: "Research Paper - Coral Microbiomes",
                    description:
                      "ML pipeline to detect heat-resilient microbiomes in corals",
                    image: "/springer.png",
                  }}
                >
                  (paper published)
              ...
              <li>
                ...
                <LinkPreview
                  ...
                  className="underline"
                  preview={{
                    title: "Cailyn Yong on Instagram",
                    description: "6.3K followers, total 2.5M views",
                    image: "/insta.png",
                  }}
                >
                  Instagram
          ...
          <p>
            I host a{" "}
            <LinkPreview
              href="https://www.instagram.com/reel/DORCr-Ukxhi/"
              className="underline"
              preview={{
                title: "Founders Weekly Coworking club",
                description: "weekly coworking club for founders in Korea",
                image: "/coworking.jpg",
              }}
            >
              Founders Weekly Coworking
            </LinkPreview>{" "}
            club every Saturday in Korea. <br></br>
            <strong>
